...
<body>
	<div class="container my-5">
		...
		<form name="myform" method="post">
			<table class="table table-bordered">
				...
				<tr>
					<th>이름</th>
					<td>
						<input type="text" name="name" id="name" value="관리자" class="form-control" />
					</td>
				</tr>
				<tr>
					<th>닉네임</th>
					<td>
						<input type="text" name="nName" id="nName" value="관리맨" class="form-control" />
					</td>
				</tr>
				<tr>
					<th>나이</th>
				...
				<tr>
					<th>성별</th>
					<td>
						<input type="radio" name="strGender" id="gender1" class="mr-2" value="남자" />
						남자&nbsp;
						<input type="radio" name="strGender" id="gender2" class="mr-2" value="여자" checked />
						여자&nbsp;
					</td>
				</tr>
				<tr>
		...
		<a href="${ctp}/0611/test10" class="btn btn-info">test10.jsp</a>
		<a href="${ctp}/0611/test11" class="btn btn-warning">test11.jsp</a>
		<hr>
		<a href="${ctp}/0611/test12/atom1234/1234" class="btn btn-secondary">test12.jsp(path variable)</a>
		<a href="${ctp}/0611/test13" class="btn btn-danger">test13.jsp(path variable)</a>
		<a href="${ctp}/0611/test14" class="btn btn-dark">test14.jsp(path variable)</a>
		<a href="${ctp}/0611/test15" class="btn btn-primary">test15(메세지)</a>
	</div>
</body>
</html>